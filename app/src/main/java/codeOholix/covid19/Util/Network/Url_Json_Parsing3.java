...
public class Url_Json_Parsing3 extends AsyncTask<Void, Void, String>{

    public List<String> temp = new ArrayList<>();

    private AsyncResponse3<String> mCallbacks;
    public Exception exception;


    Context context;

    public Url_Json_Parsing3(Context context, AsyncResponse3 mCallbacks)
    {
        this.context = context;
        this.mCallbacks=mCallbacks;
    }

    private final String URL_TOTAL_STATS="https://api.rootnet.in/covid19-in/hospitals/medical-colleges";
