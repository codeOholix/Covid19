package codeOholix.covid19.Util.UI;
...
public class Sticky_Header extends ScrollView {
    ...
    public Sticky_Header(Context context) {
        this(context, null);
    }

    public Sticky_Header(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.scrollViewStyle);
    }

    public Sticky_Header(Context context, AttributeSet attrs, int defStyle) {
